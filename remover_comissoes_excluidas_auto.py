"""
Remove comissões do banco que não existem mais na API do Sienge (automático)
"""
import os
import sys
...
def main():
    ...
    # Criar set de IDs que existem na API
    ids_api = set()
    ...
    print("\n[3/3] Identificando e removendo comissões excluídas...")
    ...
    print(f"Erros: {erros}")
    print(f"Comissões restantes: {len(comissoes_banco) - removidas}")
